...
//    g_sMPU6050Inst.pui8Data[2] = (MPU9150_ACCEL_CONFIG_ACCEL_HPF_5HZ |
                                  //MPU6050_ACCEL_CONFIG_AFSMPU9150_ACCEL_CONFIG_ACCEL_HPF_5HZ_SEL_2G);
    ...
    while(1)
    {
        ...
        //
        MPU6050DataMagnetoGetFloat(&g_sMPU6050Inst, pfMag, pfMag + 1,
                                   pfMag + 2);
